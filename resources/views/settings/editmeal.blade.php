...
<form method="POST" action="/settings/editmeal/{{ $meal->id }}" autocomplete="off" onsubmit="return validate(this);" id="nutritionform">
	<div class="col-lg-12">
		<div id="meals" class="">
	...
	<div class="col-lg-12">
		<div class="form-group">
			...
			<input type="hidden" name="meal_id" id="mealsinput" value="{{ $meal->id }}">
...
$.each(meal1.items, function(i, item) {
	addNutrtion([item.name, item.portion_name, item.calories, item.fats, item.carbs, item.proteins, item.category], item.lcount, meal1.mealnum, item.mulipiler)
});
